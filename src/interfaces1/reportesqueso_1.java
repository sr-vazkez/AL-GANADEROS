 ...
 */
public class reportesqueso_1 extends javax.swing.JFrame {

    /**
     * Creates new form reportesqueso_1
     */
    public reportesqueso_1() {
  this.setUndecorated(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reportesqueso_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new reportesqueso_1().setVisible(true);
            }
        });
    }
